...
# System prompt с инструкциями для RASA
RASA_SYSTEM_PROMPT = """
Ты - ассистент RASA, работающий с базой знаний о вымышленной вселенной.
...
# Few-shot примеры для обучения RASA
FEW_SHOT_EXAMPLES = """
...
def build_rasa_prompt(question: str, context_chunks: list, use_cot: bool = True) -> str:
    """Строит промпт для RASA с учетом контекста"""
...
"""
    ...
    if use_cot:
        return COT_PROMPT_TEMPLATE.format(
            system_prompt=RASA_SYSTEM_PROMPT,
...
def get_response_template(template_type: str = "general") -> str:
    """Возвращает шаблон ответа по типу"""
